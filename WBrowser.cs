...
namespace WBrowser
{
    public partial class WBrowser : MetroFramework.Forms.MetroForm //metrodan öncesi Form olarak klasik tasarıma geçer ve tpage.BorderStyle = BorderStyle.Fixed3D; başındaki ünlemi kaldır
    {
        ...
        private void addHistory(Uri url,string data)
        {
            ...
            else
            {
                ...
                if (favoritesPanel.Visible == true)
                {
                    ...
                    if (comboBox1.Text.Equals("Bugün ziyaret edilen"))
                    {
                    ...
                    /*view by site*/
                    if (comboBox1.Text.Equals("Siteye göre"))
                    {
                    ...
                    /* view by date*/
                    if (comboBox1.Text.Equals("Tarihe göre"))
                    {
...
//delete history
        ...
        {
                Uri url = new Uri(u);
                String iconurl = "http://yntsigorta.com/13yil.gif";
        ...
        private int faviconIndex(string url)
        {
            ...
            if (!imgList.Images.ContainsKey(key.Host.ToString()))
                imgList.Images.Add(key.Host.ToString(), favicon(url, ""));
...
//calculator
       ...
       private void helpToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            Process.Start("mailto:ferhat37ozkan@gmail.com");
        }
 #endregion         
